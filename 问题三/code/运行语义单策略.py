...
print('RUN',name,flush=True);t0=time.time();s=simulate_strategy(data,name=name,use_new_vintage=True,allow_revision=True,scenario_count=3,end_day=365,verbose=True,**kwargs);runtime=time.time()-t0
